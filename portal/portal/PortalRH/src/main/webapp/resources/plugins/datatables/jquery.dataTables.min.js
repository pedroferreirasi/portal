...
(function (Ea, Q, k) {
	var P = function (h) {
		...
		function tb(a) {
			...
			for (g =
					0; g < c; g++)
				o = b[g], l = f[g], i = "function" == typeof o.mData ? "function" : o.mData, k.columns.push({
					data: i,
					name: o.sName,
		...
		function U(a) {
			...
			for (a = 0; a < o.length; a++) {
				...
				for (c = f.length; b < c; b++)
					g = f[b], j = d[g].sType || "string", o[a]._idx === k && (o[a]._idx = h.inArray(o[a][1], d[g].asSorting)), e.push({
						src: i,
						col: g,
						dir: o[a][1],
						index: o[a]._idx,
		...
		t.extend = function (a, b, c) {
			if (c.length && b && (b instanceof t || b.__dt_wrapper)) {
				...
				e = 0;
				for (d = c.length; e < d; e++)
					f = c[e], b[f.name] = "function" === typeof f.val ? g(a, f.val, f) : h.isPlainObject(f.val) ? {}
				 : f.val,
